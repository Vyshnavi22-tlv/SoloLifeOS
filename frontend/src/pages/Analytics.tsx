  ...
  return (
    <div className="space-y-6 max-w-6xl mx-auto">
      <div>
        ...
        <p className="text-slate-500 mt-1">Get productivity scores, weekly performance reviews, and AI insights.</p>
      </div>

      <div className="glass-card-pink p-6 rounded-2xl flex items-center justify-center min-h-[300px]">
        <div className="text-center">
          <p className="text-slate-400">Habit consistency charts and productivity trends placeholder.</p>
